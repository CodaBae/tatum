  ...
  return (
    ...
    >
       <div className="px-5 py-[32px] flex flex-col gap-[36px]">
          <p className="font-medium text-grava text-[#334E69] text-base uppercase">Home</p>
          <div className="flex flex-col">
            <div className="flex items-center justify-between" onClick={handleAbout}>
              <p className="font-medium text-grava text-[#334E69] text-base uppercase">About Us</p>
              {openAboutDropdown ? <IoIosArrowUp className='text-[#141B34] text-[24px]'/> : <IoIosArrowDown className='text-[#141B34] text-[24px]' />}
            </div>
              {
                openAboutDropdown && (
                  <div className='flex flex-col gap-3 mt-3'>
                      <p onClick={() => {navigate("/"); window.scrollTo(0,0); handleClose()}} className="text-grava text-[#334E69] text-base uppercase">COMPANY OVERVIEW</p>
                      <p onClick={() => {navigate("/"); window.scrollTo(0,0); handleClose()}} className="text-grava text-[#334E69] text-base uppercase">MISSION AND VISION</p>
                      <p onClick={() => {navigate("/"); window.scrollTo(0,0); handleClose()}} className="text-grava text-[#334E69] text-base uppercase">SERVICES</p>
                      <p onClick={() => {navigate("/"); window.scrollTo(0,0); handleClose()}} className="text-grava text-[#334E69] text-base uppercase">BOARD MEMBERS</p>
                      <p onClick={() => {navigate("/"); window.scrollTo(0,0); handleClose()}} className="text-grava text-[#334E69] text-base uppercase">CAREERS</p>
                  </div>
                )
              }
          </div>
          <div className="flex flex-col">
            <div className="flex items-center justify-between" onClick={handlePersonal}>
              <p className="font-medium text-grava text-[#334E69] text-base uppercase">PERSONAL</p>
          ...
          <div className="flex flex-col">
            <div className="flex items-center justify-between" onClick={handleSme}>
              <p className="font-medium text-grava text-[#334E69] text-base uppercase">sme</p>
          ...
          <div className="flex flex-col">
            <div className="flex items-center justify-between" onClick={handleCorporate}>
              <p className="font-medium text-grava text-[#334E69] text-base uppercase">Corporate</p>
          ...
          <div className="flex flex-col">
            <div className="flex items-center justify-between" onClick={handlePrivate}>
              <p className="font-medium text-grava text-[#334E69] text-base uppercase">Private</p>
          ...
          <div className="flex flex-col">
            <div className="flex items-center justify-between" onClick={handleResources}>
              <p className="font-medium text-grava text-[#334E69] text-base uppercase">Resources</p>
          ...
          <p className="font-medium text-grava text-[#334E69] text-base uppercase">Help & Support</p>
          <p className="font-medium text-grava text-[#334E69] text-base uppercase">Contact us</p>
       </div>
    </div>
  )
}
