            ...
            >
                <div className='w-full flex flex-col items-start relative z-30 gap-[64px] lm:gap-[113px]'>
                    <div className='flex w-full flex-col items-start gap-2 lg:gap-5'>
                        ...
                        >
                            Take Your Business To  <span className='font-bold'>The Next Level</span>
                        </p>
                        <p 
                ...
                <img 
                    src={Smiling} 
                    alt='Family' 
                    className={`animate__animated animate__zoomIn relative lm:right-24 lm:-top-5  h-[605px] lg:mt-40 lm:h-[641px]`} 
                />
            </div>
        </section>
