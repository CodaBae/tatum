        ...
        <div className="flex flex-col lg:flex-1">
          <div ref={introductionRef} className="flex gap-[40px] flex-col">
            <div className="flex flex-col gap-4">
              ...
              <p className="font-[300] text-[#002244] font-grava text-base lg:text-[18px] lg:leading-[150%] leading-6">
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="font-[300] text-[#002244] font-grava text-base lg:leading-[150%] tracking-[0.01em] leading-6 lg:text-[18px]">
            ...
            <div className="flex flex-col gap-4">
              <p className="font-[450] leading-[25px] lm:leading-[30px] text-[20px]  text-[#002244] tracking-wide font-grava">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex gap-2 flex-col">
                <p className="font-[300] text-[#002244] font-grava lg:leading-[150%] tracking-[0.01em] leading-6 text-base lg:text-[18px]">
                  The purpose of the Privacy Policy is to:
                </p>
                <ul className="list-disc pl-5 text-[#002244] font-grava lg:leading-[150%] tracking-[0.01em] leading-6 text-base lg:text-[18px] gap-2 flex flex-col">
                  <li className="font-grava font-[300]">
              ...
              <div className="flex gap-5 flex-col">
                ...
                <p className="font-grava font-[300] leading-[25px] lm:leading-[30px] text-[#002244] text-base lg:text-[18px]">
            ...
            {/* <div className="flex flex-col gap-4">
              ...
              <p className="font-grava font-[300] leading-[25px] lm:leading-[30px] text-[#002244] text-base lg:text-[18px]">
                ...
                Officer (DPO):
                <span className="block mt-1 font-grava font-[300] leading-[25px] lm:leading-[30px] text-[#002244] text-base lg:text-[18px]">
          ...
          <div
            ...
            <div className="flex flex-col gap-4">
              <p className="font-[450] text-[20px]  text-[#002244] tracking-wide font-grava">
              ...
              <table className="w-[95%] px-5">
                ...
                <tr className="border border-[#cfd4dc] ">
                  <td className=" border-[#cfd4dc] p-4 border border-y-0 font-grava text-[14px] lm:text-[18px] leading-5 lm:leading-[28px] tracking-[0.2%] lm:tracking-[1.4%] font-[300] text-[#002244] border-l-0">
                    Personal Identifiable Information (PII)
                  </td>
                  <td className=" border-[#cfd4dc] p-4 font-grava text-[14px] lm:text-[18px] leading-5 lm:leading-[28px] tracking-[0.2%] lm:tracking-[1.4%] font-[300] text-[#002244]">
                ...
                <tr className="border border-[#cfd4dc]">
                  ...
                  <td className="p-4 border-[#cfd4dc]  font-grava text-[14px] lm:text-[18px] leading-5 lm:leading-[28px] tracking-[0.2%] lm:tracking-[1.4%] font-[300] text-[#002244]">
                ...
                <tr className="border border-[#cfd4dc]">
                  <td className="border-[#cfd4dc] p-4 border font-grava text-[14px] lm:text-[18px] leading-5 lm:leading-[28px] tracking-[0.2%] lm:tracking-[1.4%] font-[300]  border-y-0 text-[#002244] border-l-0">
                    Others
                  </td>
                  <td className="p-4 border-[#cfd4dc]  font-grava text-[14px] lm:text-[18px] leading-5 lm:leading-[28px] tracking-[0.2%] lm:tracking-[1.4%] font-[300] text-[#002244]">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-4">
                <p className="font-grava font-[300] leading-[25px] lm:leading-[30px] text-[#002244] text-base lg:text-[18px]">
                  ...
                  <ul className="list-disc pl-5 font-grava font-[300] leading-[25px] lm:leading-[30px] text-[#002244] text-base lg:text-[18px]">
                    <li>
          ...
          <div ref={personalRef} className="flex flex-col gap-4 mt-[40px]">
            <div className="flex flex-col gap-4">
              ...
              <ul className="list-disc pl-5 font-grava font-[300] leading-[25px] lm:leading-[30px] text-[#002244] text-base lg:text-[18px] gap-2 flex flex-col">
          ...
          <div ref={sharingRef} className="flex flex-col gap-4 mt-[40px]">
            ...
            <ul className="list-disc pl-5 font-grava font-[300] leading-[25px] lm:leading-[30px] text-[#002244] text-base lg:text-[18px] gap-3 flex flex-col">
              <li className="font-[450]">
                Parties with Whom We May Share Your Data.
                <ul className="list-decimal pl-5  font-grava font-[300] leading-[25px] lm:leading-[30px] text-[#002244] text-base lg:text-[18px] mt-3 gap-2 flex flex-col">
                  <li>
          ...
          <div ref={rightsRef} className="flex flex-col gap-4 mt-[40px]">
            ...
            <div className="flex flex-col gap-5">
              <table className="w-[100%] mt-[26px] px-5">
                ...
                <tr className="border h-[100px] border-[#cfd4dc] ">
                  <td className="p-4 border-[#cfd4dc]  border border-y-0 font-grava text-[14px] lm:text-[18px] leading-5 lm:leading-[28px] tracking-[0.2%] lm:tracking-[1.4%] font-[300] text-[#002244] border-l-0">
                    Contact Name
                  </td>
                  <td className="p-4 border-[#cfd4dc]  font-grava text-[14px] lm:text-[18px] leading-5 lm:leading-[28px] tracking-[0.2%] lm:tracking-[1.4%] font-[300] text-[#002244] border border-y-0 border-l-0">
                    Fidelis Elogie
                  </td>
                  <td className="p-4 border-[#cfd4dc]  font-grava text-[14px] lm:text-[18px] leading-5 lm:leading-[28px] tracking-[0.2%] lm:tracking-[1.4%] font-[300] text-[#002244]">
          ...
          <div ref={cookiesRef} className="flex flex-col gap-4 mt-[40px]">
            ...
            <div className="flex flex-col gap-4">
              <p className="font-grava font-[450] leading-[25px] lm:leading-[30px] text-[#002244] text-base lg:text-[18px]">
                What Are Cookies?
              </p>
              <p className="font-grava font-[300] leading-[25px] lm:leading-[30px] text-[#002244] text-base lg:text-[18px]">
            ...
            <div className="flex">
              <p className="font-grava font-[300] leading-[25px] lm:leading-[30px] text-[#002244] text-base lg:text-[18px]">
                <span className="font-[450]">Cookie Preferences -</span> You can manage your cookie preferences through our website or
          ...
          <div ref={contactRef} className="flex gap-4 flex-col mt-[40px]">
            <div className="flex flex-col gap-4">
              ...
              <ul className="list-none font-[300] leading-[25px] lm:leading-[30px] text-[#002244] text-base lg:text-[18px]flex flex-col gap-2 font-grava">
                <li>
                  Email: {" "}
