    ...
    <div
      ...
      <div className="flex flex-col items-start gap-8 px-5 lg:px-16 pt-[56px] lg:pt-[64px] bg-[#fff] relative">
        ...
        <div className="flex flex-col gap-5">
          <p className="font-grava font-[450] text-[20px] leading-[28px] tracking-[1.4%] text-[#002244]">TATUM BANK NIGERIA LIMITED WEBSITE</p>
          <p className="font-grava font-[450] text-[20px] leading-[28px] tracking-wide text-[#002244]">TERMS AND CONDITIONS</p>
        ...
        <div className="flex flex-col lg:flex-1 ">
          <div ref={introductionRef} className="flex gap-4 flex-col">
            <div className="flex flex-col">
              <p className="font-[300] leading-[25px] lm:leading-[34px] text-[20px] lg:text-[24px] text-[#002244] tracking-wide font-grava">
                Welcome to Tatum Bank Nigeria Limited website (<span className="font-[450]">“Tatum Bank” or
                “The Bank”</span>). By accessing or using this website (the <span className="font-[450]">"Site"</span>),
          ...
          <div ref={contentRef} className="flex gap-2 flex-col mt-[48px]">
            ...
            <div className=" font-grava font-[300] leading-[25px] lm:leading-[30px] text-[#002244] text-base lg:text-[19px] gap-2 flex flex-col">
          ...
          <div ref={contactRef} className="flex flex-col gap-4 mt-[48px]">
            ...
            <ul className="list-none font-grava font-[300] leading-[25px] lm:leading-[30px] text-[#002244] text-base lg:text-[19px] flex flex-col gap-2">
