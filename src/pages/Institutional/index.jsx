            ...
            <section className='bg-[#fff] md:h-auto lg:h-[1028px] flex flex-col md:flex-row items-center gap-[40px] md:gap-[93px] md:justify-between py-[56px] px-5 lg:py-[88px] lg:pr-[110px] lg:pl-[86px]'>
                ...
                <div className='flex flex-col items-center md:items-start gap-5 w-full md:w-[350px] lm:w-[565px]' data-aos="fade-left" >
                    ...
                    <p className='font-grava text-[#334E69] font-medium tracking-[0.25em] uppercase text-sm text-center leading-[21px] sm:text-left sm:leading-normal'>Our Institutional Banking Solutions</p>
                        ...
                        <button
                            className='transition-all duration-500 ease-in-out bg-[#FFCC33] mt-[4px] w-[141px] lm:hidden h-[44px] rounded-tl-lg rounded-br-lg gap-2 group hover:bg-[#002244] flex items-center justify-center'
                            type='button'
            ...
            <section className='bg-[#F9FAFB] md:h-[400px] lg:h-auto flex flex-col md:flex-row items-center gap-[40px] md:gap-0 md:justify-between py-[56px] px-5 lg:py-[88px] lg:pr-[101px] lg:pl-[110px]'>
                <div className='flex flex-col items-center md:items-start gap-5 w-[250px] md:w-[350px] lm:w-[565px]' data-aos="fade-right" >
                    <div className="flex flex-col gap-2 md:gap-4 md:items-start items-center">
                        ...
                        <button
                            className='transition-all duration-500 ease-in-out bg-[#FFCC33] mt-[4px] w-[293px] lm:hidden h-[44px] rounded-tl-lg rounded-br-lg gap-2 group hover:bg-[#002244] flex items-center justify-center'
                            type='button'
                            onClick={() => navigate("/institutional/account", {state: {
                                section: "account"
                            }})}
  ...
  >
    ...
    >
      <div className="flex flex-col lm:w-[615px] lm:h-[312px] gap-[20px]">
        ...
        <button
          className={`animate__animated animate__slow animate__fadeInUp transition-all duration-500 ease-in-out bg-[#002244] group hover:bg-[#FFCC33] hover:border hover:border-[#002244] w-[164px] rounded-tl-lg rounded-br-lg h-[58px] gap-2 flex items-center p-4 lm:mt-[80px] justify-center`}
          type='button'
