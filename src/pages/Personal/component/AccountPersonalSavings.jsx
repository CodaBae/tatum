  ...
  return (
    <div className='w-full overflow-hidden' ref={accountRef}>
    {
            ...
            >
                <div className='w-full flex flex-col items-start relative z-30 gap-[64px] lm:gap-[113px]'>
                    <div className='flex w-full flex-col items-start gap-2 lg:gap-5'>
                        ...
                        >
                            Your Dreams, Your Savings. <span className='font-bold'>Your Smile.</span>
                        </p>
                        <p 
                            // 
                        ...
                        >
                            We believe your savings should work as hard as you do.
                            That's why at Tatum, our savings solutions are designed to support every goal, from the
                            little wins to big life moments.
                        </p>
        ...
        <section className="w-full h-full">
            ...
            title={`  Your Dreams, Your Savings. <span class='font-bold'>Your Smile.</span>`}
            content={`We believe your savings should work as hard as you do.
                    That's why at Tatum, our savings solutions are designed to support every goal, from the
                    little wins to big life moments.`} 
            link={"/personal"} 
            sectionName={"savings"} 
        ...
        <section className='bg-[#FFF] flex flex-col lm:flex-row items-start lm:h-min lm:gap-[64px] gap-[48px] py-[56px] px-5 lm:py-[80px] lm:px-[59px]'>
            ...
            >
              ...
              >
                ...
                >
                    Reach our dedicated contact center team anytime for assistance.
                </p>
              </div>
            </div>
            ...
            >
              ...
              >
                ...
                >
                   Accounts designed for individuals, startups, and enterprises.
                </p>
              </div>
            </div>
...
export default AccountPersonalSavings