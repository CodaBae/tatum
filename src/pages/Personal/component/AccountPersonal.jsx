  ...
  return (
    <div className='w-full overflow-hidden' ref={accountRef}>
    {
        ...
        >
            ...
            >
                <p className='font-[400] text-[#B0B0B0] lg:text-[18px] font-grava '>Account opening available soon</p>
        ...
        <section className='bg-[#FFF] flex flex-col lm:flex-row items-start lm:gap-[64px] gap-[48px] py-[56px] px-5 lm:py-[80px] lm:px-[59px]'>
            ...
            <div className='flex flex-col w-full lm:w-[810px]'>
                <div className='flex flex-col gap-6 cursor-pointer border border-[#E6E9EC] border-x-0 border-t-0 pb-5' onClick={handleTabOne}>
                    ...
                    <p className='text-[#546B82] font-grava text-base font-[500] lm:text-[20px] leading-[25px] tracking-[0.2%]'>Secure & Reliable</p>
                    {openTabOne ? <img src={Minus} alt='Minus' className='' /> : <img src={Plus} alt='Plus' className='' />}
                    </div>
                    {openTabOne && <p className='font-[400] font-grava tracking-[0.2%] text-base lm:text-[18px] leading-[27px] text-[#334E69]'>Your data is protected with industry-leading encryption.</p>}
                </div>
                <div className='flex flex-col gap-6 cursor-pointer border border-[#E6E9EC] border-x-0 border-t-0 py-[32px]' onClick={handleTabTwo}>
                    <div className='flex items-center justify-between'>
                    <p className='text-[#546B82] font-grava text-base font-[500] lm:text-[20px] leading-[25px] tracking-[0.2%]'>24/7 Support</p>
                    {openTabTwo ? <img src={Minus} alt='Minus' className='' /> : <img src={Plus} alt='Plus' className='' />}
                    </div>
                    {openTabTwo && <p className='font-[400] font-grava tracking-[0.2%] text-base lm:text-[18px] leading-[27px] text-[#334E69]'>Reach our dedicated contact center team anytime for assistance.</p>}
                </div>
                <div className='flex flex-col gap-6 cursor-pointer border border-[#E6E9EC] border-x-0 border-t-0 py-[32px]' onClick={handleTabThree}>
                    <div className='flex items-center justify-between'>
                    <p className='text-[#546B82] font-grava text-base font-[500] lm:text-[20px] leading-[25px] tracking-[0.2%]'>Tailored Solutions</p>
                    {openTabThree ? <img src={Minus} alt='Minus' className='' /> : <img src={Plus} alt='Plus' className='' />}
                    </div>
                    {openTabThree && <p className='font-[400] font-grava tracking-[0.2%] text-base lm:text-[18px] leading-[27px] text-[#334E69]'>Accounts designed for individuals, startups, and enterprises.</p>}
                </div>
            </div>
        </section>
