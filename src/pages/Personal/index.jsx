  ...
  return (
    <div className="overflow-hidden">
      ...
      >
        ...
        >
          <div className="flex flex-col gap-2 md:gap-3 md:items-start items-center">
            <p className="font-grava text-[#334E69] lm:ml-1 font-[450] text-[11px] lg:text-[14px] tracking-[0.25em] uppercase text-sm">
              Savings Account
            </p>
            ...
            <p className="text-[14px] lm:text-[18px] text-[#002244] font-grava font-[300] leading-[20px] lg:leading-[27px] text-center md:text-left tracking-[0.2%]">
      ...
      >
        ...
        >
          <div className="flex flex-col gap-2 md:gap-3 md:items-start items-center">
            <p className="font-grava text-[#334E69] font-[450] lm:ml-1 tracking-[0.25em] uppercase text-sm text-[11px] lg:text-[14px] ">
              Current Account
            </p>
            <p className="font-[450] text-[#002244] font-grava text-center md:text-left text-[24px] lg:text-[48px] leading-[30px] lg:leading-[60px]">
              Enjoy simplified <br /> transactions daily
            </p>
            <p className="text-[14px] lm:text-[18px] text-[#002244] font-grava font-[300] leading-[27px] text-center md:text-left tracking-[0.2%] w-[318px] lm:w-full">
      ...
      >
        ...
        >
          <div className="flex flex-col gap-2 md:gap-3 md:items-start items-center">
            ...
            <p className="text-[14px] text-[#002244] lm:text-[18px] font-grava font-[300] leading-[27px] text-center md:text-left tracking-[0.2%] w-[318px] lm:w-full">
        ...
        <div className="flex gap-3 flex-col lm:w-[627px] mx-auto">
          <div className="flex items-center justify-center gap-2">
            ...
            <div className="w-[172px] rounded-[16px] h-[29px] bg-[#FFEFC0] flex flex-col items-center justify-center text-[11px] lg:text-[14px]">
              <p className="font-grava text-[12px] font-[450] text-[#546B82] uppercase leading-[12px]">
                to be available soon
              </p>
            </div>
          </div>
      ...
      >
        <div className="flex flex-col w-[296px] mx-auto gap-3 items-center">
          ...
          <p className="font-[300] font-grava text-[#334E69] text-sm leading-[20px] lm:text-[18px] lm:leading-[27px]">
        ...
        <button
          ...
          // }
        >
          <p className=" text-[#002244] font-[450] font-grava text-[14px] lm:leading-6 lg:text-[18px]">
            To be available soon
          </p>
        </button>
      </div>
      ...
      >
        <div className="flex flex-col items-center lm:w-[627px] gap-3">
          <p className="font-grava text-[#002244] font-[450]  capitalize text-sm  lg:text-[18px] ">
            Digital Banking
          </p>
