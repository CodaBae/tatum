      ...
      <div className="flex items-start gap-8 px-5 lg:px-16 pt-[56px] lg:pt-[64px] bg-[#fff] relative">
        ...
        <div className="flex flex-col lg:h-[800px] lg:overflow-y-auto lg:flex-1 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]"> {/*  "flex flex-col lg:h-[800px] lg:overflow-y-scroll lg:flex-1" */}
          <div ref={introductionRef} className="flex gap-[40px] flex-col">
            <div className="flex flex-col gap-4">
              <p className="font-[450] leading-[25px] lm:leading-[30px] text-[20px] lg:text-[24px] text-[#002244] tracking-wide font-grava">
                1.0 INTRODUCTION
              </p>
              <p className="font-[300] text-[#002244] font-grava text-base lg:text-[19px] lg:leading-[28px] leading-6">
          ...
          <div
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="font-grava font-[300] leading-[25px] lm:leading-[30px] text-[#002244] text-base lg:text-[19px]">
              ...
              <ul className="list-disc pl-5 font-grava font-[300] leading-[25px] lm:leading-[30px] text-[#002244] text-base lg:text-[19px] gap-2 flex flex-col">
            ...
            <div className="flex flex-col mt-[20px] gap-5">
              ...
              <table className="w-[100%]  px-5">
                <thead>
                    ...
                    <th className="border-[#cfd4dc] text-left w-[30%] font-grava text-[14px] lm:text-[19px] leading-5 lm:leading-[28px] tracking-[0.2%] lm:tracking-[1.4%] font-[450] text-[#002244] p-2 border border-y-0 border-l-0">
                        Cookie
                    </th>
                    <th className=" border-[#cfd4dc] text-left p-2 text-[#002244] text-[14px] lm:text-[19px] leading-5 lm:leading-[28px] tracking-[0.2%] lm:tracking-[1.4%] font-[450] font-grava border border-y-0 border-l-0">
                        Type
                    </th>
                    <th className="border-[#cfd4dc]  text-left p-2 text-[#002244] text-[14px] lm:text-[19px] leading-5 lm:leading-[28px] tracking-[0.2%] lm:tracking-[1.4%] font-[450] font-grava">
                        Purpose
                    </th>
                    </tr>
                </thead>
                <tbody>
                    <tr className="border border-[#cfd4dc]">
                      <td
                        rowSpan={2}
                        className="p-2 border-[#cfd4dc]  border border-y-0  font-grava text-[14px] lm:text-[19px] leading-5 lm:leading-[28px] tracking-[0.2%] lm:tracking-[1.4%] font-[300] text-[#002244] border-l-0 align-center"
                      >
                        Strictly Necessary Cookies
                      </td>
                      <td className="border border-[#cfd4dc] border-r border-y-0 border-l-0 p-2 font-grava text-[14px] lm:text-[19px] leading-5 lm:leading-[28px] tracking-[0.2%] lm:tracking-[1.4%] font-[300] text-[#002244]">Core</td>
                      <td className="p-2 border-[#cfd4dc]  font-grava text-[14px] lm:text-[19px] leading-5 lm:leading-[28px] tracking-[0.2%] lm:tracking-[1.4%] font-[300] text-[#002244]">
                    ...
                    <tr className="border border-[#cfd4dc]">
                      <td className="border border-[#cfd4dc] border-r border-y-0 border-l-0 p-2 font-grava text-[14px] lm:text-[19px] leading-5 lm:leading-[28px] tracking-[0.2%] lm:tracking-[1.4%] font-[300] text-[#002244]">Technical performance</td>
                      <td className="p-2 border-[#cfd4dc]  font-grava text-[14px] lm:text-[19px] leading-5 lm:leading-[28px] tracking-[0.2%] lm:tracking-[1.4%] font-[300] text-[#002244]">
                    ...
                    <td className="p-2 border-[#cfd4dc]  border border-y-0 font-grava text-[14px] lm:text-[19px] leading-5 lm:leading-[28px] tracking-[0.2%] lm:tracking-[1.4%] font-[300] text-[#002244] border-l-0">
                        Functional Cookies
                    </td>
                    <td className="p-2 border-[#cfd4dc]  font-grava text-[14px] lm:text-[19px] leading-5 lm:leading-[28px] tracking-[0.2%] lm:tracking-[1.4%] font-[300] text-[#002244] border border-y-0 border-l-0">
              ...
              <p className="font-grava font-[300] leading-[25px] lm:leading-[30px] text-[#002244] text-base lg:text-[19px]">
                ...
                <ul className="list-disc pl-5 font-grava font-[300] leading-[25px] lm:leading-[30px] text-[#002244] text-base lg:text-[19px]">
