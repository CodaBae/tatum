            ...
            <div className="flex flex-col mt-[20px] gap-5">
              ...
              <table className="w-[100%]  px-5">
                <thead>
                    ...
                    <th className="text-left w-[30%] font-grava text-[14px] lm:text-[19px] leading-5 lm:leading-[28px] tracking-[0.2%] lm:tracking-[1.4%] font-[500] text-[#002244] p-2 border border-y-0 border-l-0">
                        Cookie
                    </th>
