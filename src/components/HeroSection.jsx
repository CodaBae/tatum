      ...
      >
        <div className="w-full lg:w-[15%] flex flex-col items-start relative z-30 gap-[64px] lg:gap-[113px] lg:mt-[-6%]">
          <div className="flex w-full flex-col items-start gap-2 lg:gap-5">
            ...
            <p className="animate__animated animate__fadeInUp animate__delay-08s md:w-[265px] lg:w-[731px]  font-[300] text-sm font-grava lg:text-[25px] text-[34px] text-left text-[#002244] leading-[20px] lg:leading-[34px]">
              {content}
            </p>
            <div className="flex items-center mt-[10px] mb-[-5%] lg:mt-[12px] gap-3 animate__animated animate__fadeInUp animate__delay-10s">
              {btnText && (
                ...
                >
                  <p className="transition-colors duration-500 ease-in-out whitespace-nowrap font-medium lg:text-base font-grava text-[#FFCC33] group-hover:text-[#002244]">
                    {btnText}
                  </p>
                  <BsArrowRight
                    size={100}
